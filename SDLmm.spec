...
Jest to łącznik między C++ a SDL (Simple DirectMedia Layer),
niskopoziomową biblioteką multimedialną. SDLmm wykorzysta cechy C++
wciąż będąc w składni (i w nazewnictwie) blisko SDL.
...
Pliki nagłówkowe do rozwijania aplikacji używających SDLmm.
